    ...
    <div class="subscribe-wrap">
        <div class="container">
            <div class="subscribe">
                ...
                <p class="txt-1 center">Contact us with your request directly using online contact form or send us your
    ...
    <div class="footer-wrap">
        <div class="container">
            ...
            <div class="footer-bottom">
                <a href="mailto:info@shf-science.com"><img src="{{$baseUrl}}img/at.svg" alt=""> info@shf-science.com</a>
    ...
    <div class="popup-content">
        ...
        <div class="popup-right">
            ...
            <form action="" method="POST" id="register-form" autocomplete="off">
                ...
                <div class="form-grp">
                    <input class="form-field" type="text" id="email" name="email" placeholder="your@email.com" />
                    <div class="error"></div>
                </div>
                <div class="form-grp">
